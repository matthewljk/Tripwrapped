...
export default function WrapItUpPage() {
  ...
  if (!token) {
    return (
      <div className="flex min-h-dscreen-half flex-col items-center justify-center bg-slate-50 content-padding-x py-16 content-wrap">
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-6xl content-padding-x content-wrap">
